...
MODULE_DESCRIPTION("Xtables: conntrack-less raw NAT with port randomization");
MODULE_LICENSE("GPL");
MODULE_ALIAS("ipt_RAWSNAR");
MODULE_ALIAS("ipt_RAWDNAR");
MODULE_ALIAS("ip6t_RAWSNAR");
MODULE_ALIAS("ip6t_RAWDNAR");
